...
export default function AutoLoanRefinance() {
  ...
  useEffect(() => {
    // Dynamically import autoLoanRefinance data from data.js
    import(`../../data.js`)
      .then((dataModule) => {
        const autoLoanRefinanceData = (dataModule as any).autoLoanRefinance;
        if (Array.isArray(autoLoanRefinanceData)) {
          setLoanDataArray(autoLoanRefinanceData);
        } else {
          setLoanDataArray([]);
        }
        setLoading(false);
      ...
      .catch((error) => {
        console.error("Error loading autoLoanRefinance data:", error);
        setLoanDataArray([]);
        setLoading(false);
      });
  }, []);
      ...
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {t("no.data.found.for")} Auto Loan Refinance
          </p>
        </div>
      </div>
    );
      ...
      <main className="w-full px-6 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">
            {t("auto.loan.refinancing.title")}
          </h1>
          <p className="text-gray-700">
            {t("auto.loan.refinancing.description")}
          </p>
        ...
        <div className="overflow-x-auto">
          <div className="min-w-[1200px]">
            {/* Header Row */}
            <div className="grid grid-cols-7 gap-4 py-4 border-b-2 border-gray-200 bg-gray-50">
            ...
            {filteredLoans.map((loan, index) => (
              <div
                key={loan.id || index}
                className="grid grid-cols-7 gap-4 py-4 border-b border-gray-100"
              >
                {/* PRODUCT */}
                ...
                <div>
                  <div className="text-sm font-medium text-gray-800 mb-2">
                    {loan.creditScore?.minValue || t("n.a")} -{" "}
                    {loan.creditScore?.maxValue || t("n.a")}
                  </div>
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (((loan.creditScore?.maxValue || 850) -
                              (loan.creditScore?.minValue || 300)) /
                              (850 - 300)) *
                            100
                          }%`,
                          marginLeft: `${
                            (((loan.creditScore?.minValue || 300) - 300) /
                              (850 - 300)) *
                            100
                          }%`,
                        }}
                  ...
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (((loan.loanAmount?.maxValue || 200000) -
                              (loan.loanAmount?.minValue || 500)) /
                              (200000 - 500)) *
                            100
                          }%`,
                          marginLeft: `${
                            (((loan.loanAmount?.minValue || 500) - 500) /
                              (200000 - 500)) *
                            100
                          }%`,
                        }}
                  ...
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (((loan.apr?.maxValue || 36) -
                              (loan.apr?.minValue || 2)) /
                              (36 - 2)) *
                            100
                          }%`,
                          marginLeft: `${
                            (((loan.apr?.minValue || 2) - 2) / (36 - 2)) * 100
                          }%`,
                        }}
                      />
                    </div>
                  ...
                  <div className="relative">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (((loan.loanTerm?.maxValue || 96) -
                              (loan.loanTerm?.minValue || 6)) /
                              (96 - 6)) *
                            100
                          }%`,
                          marginLeft: `${
                            (((loan.loanTerm?.minValue || 6) - 6) / (96 - 6)) *
                            100
                          }%`,
                        }}
                      />
