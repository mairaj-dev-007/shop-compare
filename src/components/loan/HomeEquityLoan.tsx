    ...
    import(`../../data.js`)
      .then((dataModule) => {
        ...
        if (Array.isArray(homeEquityLoanData)) {
          setLoanDataArray(homeEquityLoanData);
        } else {
          setLoanDataArray([]);
        }
        setLoading(false);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">No data found for Home Equity Loan</p>
        </div>
      </div>
    );
  }
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Home Equity Loans: Reviews & Comparisons
          </h1>
          <p className="text-gray-600 text-lg">
            Looking for a home equity loan? You've come to the right place. But
