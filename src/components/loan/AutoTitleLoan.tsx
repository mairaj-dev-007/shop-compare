...
export default function AutoTitleLoan() {
  ...
  useEffect(() => {
    // Dynamically import autoTitleLoan data from data.js
    import(`../../data.js`)
      .then((dataModule) => {
        const autoTitleLoanData = (dataModule as any).autoTitleLoan;
        if (Array.isArray(autoTitleLoanData)) {
          setLoanDataArray(autoTitleLoanData);
        } else {
          setLoanDataArray([]);
        }
        setLoading(false);
      ...
      .catch((error) => {
        console.error("Error loading autoTitleLoan data:", error);
        setLoanDataArray([]);
        setLoading(false);
      });
  }, []);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">No data found for Auto Title Loan</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <ChevronRight className="h-4 w-4 text-gray-400" />
              <span className="text-gray-800 font-medium">AUTO TITLE LOAN</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">
            Auto Title Loans: Reviews & Comparisons
          </h1>
          <p className="text-gray-600 text-lg">
            Looking for an auto title loan? You've come to the right place. But
            what should you look for in an auto title loan?
          </p>
