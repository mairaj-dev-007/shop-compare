...
export default function AutoLoan() {
  ...
  useEffect(() => {
    // Dynamically import autoLoan data from data.js
    import(`../../data.js`)
      .then((dataModule) => {
        const autoLoanData = (dataModule as any).autoLoan;
        if (Array.isArray(autoLoanData)) {
          setLoanDataArray(autoLoanData);
        } else {
          setLoanDataArray([]);
        }
        setLoading(false);
      ...
      .catch((error) => {
        console.error("Error loading autoLoan data:", error);
        setLoanDataArray([]);
        setLoading(false);
      });
  }, []);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">{t("no.data.found.for")} Auto Loan</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full px-6 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700">{t("auto.loans.description")}</p>
          <div className="mt-4 text-sm text-gray-600">
            Showing{" "}
            {
              loanDataArray.filter((loan) => {
            ...
            return (
              <div className="overflow-x-auto">
                <div className="min-w-[1200px]">
                  {/* Single Header Row */}
                  <div className="grid grid-cols-7 gap-4 pb-4 border-b border-gray-200 mb-6">
                    ...
                    >
                      ...
                      <div className="flex items-start gap-3">
                        <img
                          ...
                          className="h-12 w-12 object-contain bg-gray-50 rounded flex-shrink-0"
                        />
                        <div className="min-w-0">
                          ...
                          <div className="text-gray-600 text-xs mt-1">
                            {loan.reviews?.head || t("n.a")} {t("auto.loan")}
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="relative">
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{
                                width: `${
                                  (((loan.loanTerm?.maxValue || 240) -
                                    (loan.loanTerm?.minValue || 6)) /
                                    (240 - 6)) *
                                  100
                                }%`,
                                marginLeft: `${
                                  (((loan.loanTerm?.minValue || 6) - 6) /
                                    (240 - 6)) *
                                  100
                                }%`,
                              }}
